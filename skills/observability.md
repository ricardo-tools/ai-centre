...
Instrument your application so you know when it's broken, what's slow, and which features users hit — for pre-deploy quality, see **verification-loop** and **testing-strategy**.
...
- Pre-deploy testing and verification — see **testing-strategy**, **verification-loop**
