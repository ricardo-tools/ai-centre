...
- Extend all edge-touching elements to the full bleed boundary. Not: backgrounds that stop at the trim edge (causes white edge strips after cutting)
- Place all text, logos, and QR codes inside the safe zone (4mm inset). Not: content placed outside the safe zone
- Embed all fonts in the export; convert to outlines as a last resort. Not: fonts missing from the export (causes font substitution in PDF)
- Source all images at 300+ DPI at their printed dimensions. Not: source images below 300 DPI at print size (causes blurry/pixelated output)
- Soft-proof before print and avoid saturated blues/greens/oranges that fall outside CMYK gamut. Not: ignoring RGB-to-CMYK gamut shift
- Make the inner panel 2-3mm narrower than outer panels in tri-fold layouts. Not: inner panel same width as outer panels (causes fold misalignment)
- Pre-score paper at 170gsm or heavier before folding. Not: heavy stock folded without scoring (causes paper cracks)
- Size QR codes at minimum 10mm with a white quiet zone of 4 modules. Not: QR codes too small or missing quiet zone
- Keep total ink coverage below 300%; use rich black (C:40 M:30 Y:30 K:100) for large black areas. Not: total ink coverage too high or registration black
- Use minimum body text at 7pt and fine print at 6pt absolute minimum. Not: font sizes below minimum (causes illegible text at print size)
