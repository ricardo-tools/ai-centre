...
export function ShowcaseViewerWidget({ showcase, signedDeployUrl, sharePermissions }: ShowcaseViewerWidgetProps) {
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          {canDownload ? (
            ...
            <span
              title="You don't have download permission for this showcase"
              style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '4px 10px', borderRadius: 4, border: '1px solid var(--color-border)', background: 'var(--color-surface)', color: 'var(--color-text-muted)', fontSize: 12, fontWeight: 500, opacity: 0.5, cursor: 'not-allowed' }}
            >
              <DownloadSimple size={12} /> Download
            </span>
          )}
