...
ALTER TABLE "showcase_views" ADD CONSTRAINT "showcase_views_showcase_id_showcase_uploads_id_fk" FOREIGN KEY ("showcase_id") REFERENCES "public"."showcase_uploads"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "showcase_views" ADD CONSTRAINT "showcase_views_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "skill_downloads" ADD CONSTRAINT "skill_downloads_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;