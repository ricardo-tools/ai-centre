  ...
  return (
    <div>
      ...
      <Section title="Shell Layout Patterns">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
          ...
          <div style={{ padding: 20, borderRadius: 8, border: '1px solid var(--color-border)', background: 'var(--color-surface)' }}>
            <PatternLabel letter="A" name="TopBar + Sidebar" />
          ...
          <div style={{ padding: 20, borderRadius: 8, border: '2px solid var(--color-primary)', background: 'var(--color-surface)' }}>
            <PatternLabel letter="B" name="TopBar + Mega Menus" badge="This App" />
          ...
          <div style={{ background: 'var(--color-surface)', borderBottom: '1px solid var(--color-border)', padding: 20 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24 }}>
              {['Getting Started', 'Core Skills', 'Resources'].map((section) => (
                <div key={section}>
                  <p style={{ fontSize: 12, fontWeight: 600, color: 'var(--color-text-heading)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: '0.05em' }}>{section}</p>
      ...
      <Section title="Mobile Navigation">
        <p style={{ fontSize: 14, color: 'var(--color-text-muted)', marginBottom: 16 }}>All patterns collapse to a drawer on XS/SM. The drawer uses accordion navigation inside.</p>
